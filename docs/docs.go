...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.DeviceCreateRequestDto"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.DeviceResponseDto"
                        }
                    }
                }
            }
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.DeviceUpdateRequestDto"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/diagnostic-points/add": {
            "post": {
                ...
                "operationId": "addDiagnosticPoint",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Work Order UUID",
                    ...
                    {
                        "type": "string",
                        "description": "Diagnostic description or JSON string",
                        "name": "diagnosticPoint",
                        "in": "formData",
                        "required": true
                    },
                    {
        ...
        "/api/diagnostic-points/by-work-order/{workOrderId}/client/{clientId}": {
            "get": {
                ...
                "summary": "Obtener puntos de diagnóstico por ID de orden de trabajo",
                "operationId": "getDiagnosticPointsByWorkOrderAndClient",
                "parameters": [
                    {
                        "type": "string",
                        "format": "uuid",
        ...
        "/api/diagnostic-points/delete/{id}": {
            "delete": {
                "security": [
                    {
                        "bearer-jwt": []
                ...
                "operationId": "deleteDiagnosticPoint",
                "parameters": [
                    {
                        "type": "string",
                        "format": "uuid",
                        "description": "Diagnostic Point UUID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/api/user-roles/user-permission": {
            "get": {
                "security": [
                    {
                        "bearer-jwt": []
        ...
        "/api/v1/automation/tasks/tomorrow": {
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.TomorrowTaskDto"
                            }
                        }
                    },
                    "500": {
        ...
        "/api/v1/automation/tasks/{id}/bot-status": {
            "patch": {
                ...
                "operationId": "updateTaskBotStatus",
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID del turno (UUID)",
                    ...
                    {
                        "description": "Estado del bot (botActive)",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateBotStatusDto"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/automation/tasks/{id}/status": {
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateBookingStatusDto"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/bookings/availability": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Tipo de equipo/servicio (general | pc | laptop | mobile | gaming)",
                        "name": "deviceType",
                        "in": "query"
                    }
                ],
        ...
        "/api/work-order/save": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Work Order Create Request",
                        "name": "workOrder",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.WorkOrderCreateRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.DiagnosticPointResponseDto": {
            "type": "object",
            "properties": {
                "clientId": {
                    "type": "string"
        ...
        "models.WorkOrderStatusUpdateRequestDto": {
            "type": "object",
            "required": [
                "repairStatus"
            ],
